export type ThemePreference = "system" | "light" | "dark" | "black" | "pastel";
...
export const themeClasses = {
  dark: {
    ...
    monochromeChannelFilterHover:
      "group-hover/channel:grayscale-0 group-hover/channel:opacity-100",
  },
  light: {
    bg: "bg-white",
    text: "text-gray-900",
  ...
  black: {
    ...
    monochromeFilterHover:
      "group-hover:grayscale-0 group-hover:contrast-100 group-hover:opacity-100",
    monochromeChannelFilterHover:
      "group-hover/channel:grayscale-0 group-hover/channel:contrast-100 group-hover/channel:opacity-100",
  },
  pastel: {
    bg: "bg-[#faf6f1]",
    text: "text-[#5c5c5c]",
